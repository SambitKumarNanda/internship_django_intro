...
class UserProfileModel(models.Model):
    ...
    followers = models.ManyToManyField(UserModel,related_name="user_profile_followers",blank=True)
    posts = models.IntegerField(null=True, blank=True)
    following = models.ManyToManyField(UserModel,related_name="user_profile_following",blank=True)
